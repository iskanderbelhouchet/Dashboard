              ...
              <div className='col-xl-12 col-lg-12 col-md-12'>
                <div className='card'>
                  ...
                  <div className='card-body'>
                    <div className='chart' id='extra-area-chart' style={{ height: 300 }} />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className='row'>
              <div className='col-xl-3 col-lg-6 col-md-6 col-sm-12'>
                <div className='dashboard_stats_wrap'>
                  ...
                  <div className='dashboard_stats_wrap_content'><h4>607</h4> <span>Number of Cources</span></div>
                </div>
              </div>
              <div className='col-xl-3 col-lg-6 col-md-6 col-sm-12'>
                <div className='dashboard_stats_wrap'>
                  ...
                  <div className='dashboard_stats_wrap_content'><h4>5.2k</h4> <span>Number of Lession</span></div>
                </div>
              </div>
              <div className='col-xl-3 col-lg-6 col-md-6 col-sm-12'>
                <div className='dashboard_stats_wrap'>
              ...
              <div className='col-xl-3 col-lg-6 col-md-6 col-sm-12'>
                <div className='dashboard_stats_wrap'>
                  ...
                  <div className='dashboard_stats_wrap_content'><h4>32k</h4> <span>Number of Enrollment</span></div>
                </div>
              </div>
            </div>
            {/* /Row */}
