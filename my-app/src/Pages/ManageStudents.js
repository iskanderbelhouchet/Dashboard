            ...
            <div className='col-lg-12 col-md-12 col-sm-12 pb-4'>
              <div className='dashboard_wrap d-flex align-items-center justify-content-between'>
                ...
                <div className='elkios'>
                  <a href='add-students.html' className='add_new_btn'><i className='fas fa-plus-circle mr-1' />Add Students</a>
                </div>
              </div>
            </div>
          </div>
                      ...
                      <table className='table dash_list'>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><span className='smalls lg'>Web Designing</span></td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td><span className='smalls lg'>JavaScript</span></td>
                            <td>
                              <div className='dropdown show'>
                                <a className='btn btn-action' href='#' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
                                  <i className='fas fa-ellipsis-h' />
                          ...
                          <tr>
                            ...
                            <td><span className='smalls lg'>3D Animation</span></td>
                            <td>
                              <div className='dropdown show'>
                                <a className='btn btn-action' href='#' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
                                  <i className='fas fa-ellipsis-h' />
                          ...
                          <tr>
                            ...
                            <td><span className='smalls lg'>Laravel</span></td>
                            <td>
                              <div className='dropdown show'>
                                <a className='btn btn-action' href='#' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
                                  <i className='fas fa-ellipsis-h' />
                          ...
                          <tr>
                            ...
                            <td><span className='smalls lg'>Hraphic Design</span></td>
                            <td>
                              <div className='dropdown show'>
                                <a className='btn btn-action' href='#' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
                                  <i className='fas fa-ellipsis-h' />
