            ...
            <div className='row'>
              ...
              <div className='col-md-8'>
                  ...
                  <div className='col-md-6'>
                    ...
                    <div className='box box-danger'>
                      ...
                      <div className='box-footer text-center'>
                        <a href='void(0)' className='uppercase'>View All Users</a>
                      </div>
                      {/* /.box-footer */}
                    </div>
                    {/* /.box */}
                ...
                <div className='box box-info'>
                  ...
                  <div className='box-footer clearfix'>
                    <a href='void(0)' className='btn btn-sm btn-info btn-flat pull-left'>Place New Order</a>
                    <a href='void(0)' className='btn btn-sm btn-default btn-flat pull-right'>View All Orders</a>
                  </div>
                  {/* /.box-footer */}
                </div>
                {/* /.box */}
              ...
              <div className='col-md-4'>
                ...
                <div className='box box-default'>
                  ...
                  <div className='box-footer no-padding'>
                    <ul className='nav nav-pills nav-stacked'>
                      <li>
                        <a href='fake_url'>United States of America
                ...
                <div className='box box-primary'>
                    ...
                    <ul className='products-list product-list-in-box'>
                      <li className='item'>
                        ...
                        <div className='product-info'>
                          <a href='void(0)' className='product-title'>Samsung TV
                      ...
                      <li className='item'>
                        ...
                        <div className='product-info'>
                          <a href='void(0)' className='product-title'>Bicycle
                      ...
                      <li className='item'>
                        ...
                        <div className='product-info'>
                          <a href='void(0)' className='product-title'>Xbox One <span className='label label-danger pull-right'>$350</span></a>
                          <span className='product-description'>
                      ...
                      <li className='item'>
                        ...
                        <div className='product-info'>
                          <a href='void(0)' className='product-title'>PlayStation 4
                  ...
                  {/* /.box-body */}
                  <div className='box-footer text-center'>
                    <a href='void(0)' className='uppercase'>View All Products</a>
                  </div>
                  {/* /.box-footer */}
                </div>
                {/* /.box */}
